...
export const metadata: Metadata = {
  ...
  description:
    "ร่วมเป็นพาร์ทเนอร์ทางธุรกิจกับ Forex Thailand — โฆษณา สปอนเซอร์ Affiliate และความร่วมมือด้านสื่อ ทีมขายพร้อมติดต่อกลับ",
...
const BENEFITS = [
  ...
  "ความร่วมมือด้าน Affiliate และรีวิวโบรกเกอร์",
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-14">
          ...
          <div>
            ...
            <p className="mt-4 text-[15px] leading-relaxed text-ink-soft">
              สนใจลงโฆษณา เป็นสปอนเซอร์ ทำ Affiliate หรือร่วมมือด้านสื่อ?
